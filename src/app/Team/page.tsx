...
import one from '../images/team-1.webp';
import two from '../images/team-2.webp';
import three from '../images/team-3.webp';
import four from '../images/team-4.webp';
...
export default function Team(){
    return(
        <div className={`mb-[2%] mt-[2%] ${poppins.className}`}>
            <div className="lg:max-w-5xl max-w-3xl mx-auto">
                ...
                <div className="grid lg:grid-cols-4 md:grid-cols-3 gap-6 max-md:justify-center mt-12">
                    <div className="border rounded-lg overflow-hidden">
                        <Image src={one} alt="team member" className="w-full h-56 object-cover" />
                    ...
                    <div className="border rounded-lg overflow-hidden">
                        <Image src={two} alt="team member" className="w-full h-56 object-cover" />
                    ...
                    <div className="border rounded-lg overflow-hidden">
                        <Image src={three}alt="team member" className="w-full h-56 object-cover" />
                    ...
                    <div className="border rounded-lg overflow-hidden">
                        <Image src={four} alt="team member" className="w-full h-56 object-cover" />
